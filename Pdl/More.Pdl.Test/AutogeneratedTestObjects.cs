...
//     GenerationDateTime : 7/17/2013 7:05:51 PM
//
using System;
using System.Text;
...
namespace More.Net.PdlTestObjects
{
    ...
    public class FixedLengthArrayObject
    {
        ...
        static InstanceSerializer serializer = null;
        public static FixedLengthInstanceSerializer<FixedLengthArrayObject> Serializer
        {
            get
            {
                if(serializer == null) serializer = new InstanceSerializer();
        ...
        class InstanceSerializer : FixedLengthInstanceSerializer<FixedLengthArrayObject>
        {
            public InstanceSerializer() {}
        ...
        private FixedLengthArrayObject() { }
    ...
    {
        static InstanceSerializer serializer = null;
        public static IInstanceSerializer<DynamicLengthObject> Serializer
        {
            get
            {
                if(serializer == null) serializer = new InstanceSerializer();
        ...
        class InstanceSerializer : IInstanceSerializer<DynamicLengthObject>
        {
            public InstanceSerializer() {}
            ...
            public UInt32 Deserialize(Byte[] bytes, UInt32 offset, UInt32 offsetLimit, out DynamicLengthObject outInstance)
            {
                ...
                instance.AByteArray = bytes.CreateSubArray(offset, (UInt32)instance.AByteArray.Length);
    ...
    {
        static InstanceSerializer serializer = null;
        public static IInstanceSerializer<AnotherDynamicLengthObject> Serializer
        {
            get
            {
                if(serializer == null) serializer = new InstanceSerializer();
        ...
        class InstanceSerializer : IInstanceSerializer<AnotherDynamicLengthObject>
        {
            public InstanceSerializer() {}
            ...
            public UInt32 Deserialize(Byte[] bytes, UInt32 offset, UInt32 offsetLimit, out AnotherDynamicLengthObject outInstance)
            {
                ...
                instance.FixedObjectByteLength = bytes.CreateSubArray(offset, (UInt32)instance.FixedObjectByteLength.Length);
                instance.FixedObject24ByteLength = bytes.CreateSubArray(offset, (UInt32)instance.FixedObject24ByteLength.Length);
// NOT IMPLEMENTED
// NOT IMPLEMENTED
        ...
        private AnotherDynamicLengthObject() { }

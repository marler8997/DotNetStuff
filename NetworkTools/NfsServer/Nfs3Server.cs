...
namespace Marler.NetworkTools
{
    public class Nfs3Server : RpcServerHandler
    {
        ...
        private readonly PartialByteArraySerializable fileContents;
            ...
            : base("Nfs3", sendBuffer)
        {
            ...
            this.fileContents = new PartialByteArraySerializable(new Byte[readSizeMax], 0, 0);
        ...
        ReadReply Handle(ReadCall readCall)
        {
            ...
            Int32 bytesRead = GenericUtilities.ReadFile(shareObject.AccessFileInfo(), (Int32)readCall.offset, fileContents.bytes, out reachedEndOfFile);

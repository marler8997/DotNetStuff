...
namespace Marler.NetworkTools
{
    class Program
    {
        ...
        static void Main(String[] args)
        {
            ...
            NfsServerLog.sharedFileSystemLogger             = null;// Console.Out;
            NfsServerLog.rpcCallLogger                      = null;// Console.Out;
            NfsServerLog.warningLogger                      = null;// Console.Out;
            ...
            try
            {
                new RpcServicesManager().Run(
                    ...
                    CommonPort.PortMap, mountListenPort, CommonPort.Nfs,

...
namespace Marler.NetworkTools
{
    ...
    public class RpcProgramHeader : ObjectReflectorSerializer
    {
    ...
    public class RpcMessage : ObjectReflectorSerializer
    {
        public static readonly ISerializableReflector[] memberSerializers = new ISerializableReflector[] {
            ...
            new XdrDescriminatedUnionReflector<RpcMessageType>(
                ...
                null,                
                new XdrDescriminatedUnionReflector<RpcMessageType>.KeyAndSerializer(RpcMessageType.Call,
                    new XdrStructFieldReflector<RpcCall>(typeof(RpcMessage), "call", RpcCall.memberSerializers)),
                new XdrDescriminatedUnionReflector<RpcMessageType>.KeyAndSerializer(RpcMessageType.Reply,
            ...
            : base(memberSerializers)
        {
            ...
            GenericUtilities.ReadFullSize(socket, buffer.array, 0, 4); // read the size
            ...
            GenericUtilities.ReadFullSize(socket, buffer.array, 0, rpcMessageSize);
        ...
        public void SendTcp(Socket socket, ByteBuffer buffer, ISerializableData messageContents)
        {
        ...
        public void SendUdp(EndPoint endPoint, Socket socket, ByteBuffer buffer, ISerializableData messageContents)
        {

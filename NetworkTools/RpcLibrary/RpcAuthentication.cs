...
namespace Marler.NetworkTools
{
    ...
    public class RpcCredentials : ObjectReflectorSerializer
    {
    ...
    public class RpcUnixCredentials : ObjectReflectorSerializer
    {
        public static readonly ISerializableReflector[] memberSerializers = new ISerializableReflector[] {
    ...
    public class RpcVerifier : ObjectReflectorSerializer
    {
        public static readonly ISerializableReflector[] memberSerializers = new ISerializableReflector[] {

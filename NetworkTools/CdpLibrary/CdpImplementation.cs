...
namespace Marler.NetworkTools
{
    ...
    /*
    public class CdpDatagramMissingPayloadID
    {
        public CdpDatagramMissingPayloadID(CdpConnection connection)
            : base(connection.transmitter.RemoteEndPoint)
        {
        }
    }
    */
    ...
    class Datagram
    {
        ...
        public Datagram(Byte[] datagram, Int32 offset, Int32 length)
        {

...
namespace Marler.NetworkTools.Mount3Procedure
{
    public class Null : RpcProcedure
    {
        public Null()
            : base("Null", Mount3.NULL, VoidSerializableData.Instance, VoidSerializableData.Instance)
        {
        }
    }
    ...
    public class MountCall : ObjectReflectorSerializer
    {
    ...
    public class MountReply : ObjectReflectorSerializer
    {
        private static readonly ReflectorSerializerList mountOkSerializers = new ReflectorSerializerList(

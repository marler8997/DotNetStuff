...
using System.Net;
using Marler.NetworkTools.Nfs3Procedure;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            RpcCredentials mountCredentials = RpcCredentials.CreateUnixCredentials(new RpcUnixCredentials(stamp, //0x509d4ff4U,
                "hplx0274.boi.hp.com", 0, 0, new XdrUInt32(0), new XdrUInt32(1), new XdrUInt32(1), new XdrUInt32(2),
                    new XdrUInt32(3), new XdrUInt32(4), new XdrUInt32(6), new XdrUInt32(10), new XdrUInt32(101), new XdrUInt32(10000)
                    , new XdrUInt32(10070), new XdrUInt32(10091), new XdrUInt32(39747)));
            ...
            try
            {
                ...
                Console.WriteLine();
                Console.WriteLine(getNfsPort.reply.ToNiceString());
                ...
                Console.WriteLine();
                Console.WriteLine(getMountPort.reply.ToNiceString());
                ...
                Console.WriteLine();
                Console.WriteLine(mount.reply.ToNiceString());
                ...
                Nfs3Procedure.FileSystemInfo fileSystemInfo = new Nfs3Procedure.FileSystemInfo(new Nfs3Procedure.FsInfoCall(
                        rootDirectoryHandle
                    ));
                nfsConnection.CallBlockingTcp(fileSystemInfo, buffer);
                Console.WriteLine();

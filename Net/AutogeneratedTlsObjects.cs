...
//     GenerationDateTime : 7/12/2013 3:10:18 AM
//
using System;
using System.Text;
...
namespace More.Net.TlsCommand
{
    ...
    public class ProtocolVersion
    {
        ...
        class InstanceSerializer : FixedLengthInstanceSerializer<ProtocolVersion>
        {
            ...
            public override Int32 FixedSerializationLength() { return ProtocolVersion.FixedSerializationLength; }
            public override void FixedLengthSerialize(Byte[] bytes, Int32 offset, ProtocolVersion instance)
            {
            ...
            public override ProtocolVersion FixedLengthDeserialize(Byte[] bytes, Int32 offset)
            {
    ...
    public class Extension
    {
        ...
        {
            public InstanceSerializer() {}
            public Int32 SerializationLength(Extension instance)
            {
                int dynamicLengthPart = 0;
                dynamicLengthPart += instance.Content.SerializationLength();
                return 2 + dynamicLengthPart;
            }
            public Int32 Serialize(Byte[] bytes, Int32 offset, Extension instance)
            {
            ...
            public Int32 Deserialize(Byte[] bytes, Int32 offset, Int32 offsetLimit, out Extension outInstance)
            {
    ...
    public class TlsRecord
    {
        ...
        {
            public InstanceSerializer() {}
            public Int32 SerializationLength(TlsRecord instance)
            {
                int dynamicLengthPart = 0;
                dynamicLengthPart += instance.Content.SerializationLength();
                return 3 + dynamicLengthPart;
            }
            public Int32 Serialize(Byte[] bytes, Int32 offset, TlsRecord instance)
            {
            ...
            public Int32 Deserialize(Byte[] bytes, Int32 offset, Int32 offsetLimit, out TlsRecord outInstance)
            {
    ...
    public class TlsHandshakeRecord
    {
        ...
        {
            public InstanceSerializer() {}
            public Int32 SerializationLength(TlsHandshakeRecord instance)
            {
                int dynamicLengthPart = 0;
                dynamicLengthPart += instance.Content.SerializationLength();
                return 1 + dynamicLengthPart;
            }
            public Int32 Serialize(Byte[] bytes, Int32 offset, TlsHandshakeRecord instance)
            {
            ...
            public Int32 Deserialize(Byte[] bytes, Int32 offset, Int32 offsetLimit, out TlsHandshakeRecord outInstance)
            {
    ...
    public class ClientHello
    {
        ...
        {
            public InstanceSerializer() {}
            public Int32 SerializationLength(ClientHello instance)
            {
                int dynamicLengthPart = 0;
                if(instance.SessionID != null) dynamicLengthPart += instance.SessionID.Length * 1;
                if(instance.CipherSuites != null) dynamicLengthPart += instance.CipherSuites.Length * 2;
                if(instance.CompressionMethods != null) dynamicLengthPart += instance.CompressionMethods.Length * 1;
            ...
            public Int32 Serialize(Byte[] bytes, Int32 offset, ClientHello instance)
            {
                bytes[offset] = instance.MajorVersion;
                offset += 1;
                bytes[offset] = instance.MinorVersion;
            ...
            public Int32 Deserialize(Byte[] bytes, Int32 offset, Int32 offsetLimit, out ClientHello outInstance)
            {
